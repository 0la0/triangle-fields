...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  var closeLoader = function closeLoader() {
    return browserWindow.webContents.executeJavaScript('closeLoader()');
  };
...
/* harmony import */ var _util_Math__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../util/Math */ "./src/util/Math.js");
/* harmony import */ var _util_Intersection__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../util/Intersection */ "./src/util/Intersection.js");
/* harmony import */ var _geometry_Point__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../geometry/Point */ "./src/geometry/Point.js");
...
function createSquareField(numPoints, edgePoints) {
  ...
  for (var i = 0; i < numColumns; i++) {
    for (var j = 0; j < numRows; j++) {
      var potentialPoint = new _geometry_Point__WEBPACK_IMPORTED_MODULE_6__["default"](i * xStride + bounds.minX, j * yStride + bounds.minY);
...
function createRadialField(numPoints, edgePoints) {
  ...
  for (var t = 0; t < numSectors; t++) {
    for (var r = 1; r < numSegments; r++) {
      ...
      var potentialPoint = new _geometry_Point__WEBPACK_IMPORTED_MODULE_6__["default"](radius * Math.cos(theta) + centroid.x, radius * Math.sin(theta) + centroid.y);
